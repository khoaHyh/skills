...
- **review-remediation**: Address a frozen set of PR feedback from any human or automated reviewer using primary-source research and minimum durable, robust fixes.
- **local-adversarial-review-gauntlet**: Run deadline-enforced behavior and risk-specialist reviews against one immutable local diff, then assemble supported findings.
